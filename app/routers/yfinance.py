...
import pandas as pd
from ..model.tickers import Ticker as ModelTickers
from typing import List
from .utils import get_tickers_list
...
async def list_tickers() -> List[dict[str, str]]:
    """
    Retorna a lista de todos os tickers disponíveis
    :return: Lista de todos os tickers
    """
